    ...
    <div className="flex flex-col md:flex-row justify-between md:justify-normal md:items-start ">
      <div className="flex flex-col">
        <div className="flex flex-row justify-between my-3 md:mb-3 md:my-0 md:items-start md:justify-normal">
          ...
          <button
            className="w-[65px] md:hidden md:w-[80px] py-1.5 bg-primary_50 text-black text-sm text-center font-semibold"
          >
            Donate
          </button>
        </div>
        ...
        <div className="flex space-x-2 my-4">
          <Link href="#" className="hover:underline">
            <Image  src="/images/FSS-assets/icon-twitter.svg" alt="twitter button" width={18} height={18} />
          </Link>
          <Link href="#" className="hover:underline">
            <Image src="/images/FSS-assets/icon-facebook.svg" alt="facebook button" width={18} height={18} />
          </Link>
          <Link href="#" className="hover:underline">
            <Image src="/images/FSS-assets/icon-instagram.svg" alt="instagram button" width={18} height={18} />
          </Link>
        </div>
      </div>
